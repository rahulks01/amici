    ...
    return (
      ...
      >
            ...
            {selected.map((option) => {
              return (
                <Badge
                  key={option.value}
                  className={cn(
                    "data-[disabled]:bg-muted-foreground data-[disabled]:text-muted data-[disabled]:hover:bg-muted-foreground bg-indigo-500 p-2",
                ...
                >
                  ...
                  >
                    <X className="h-4 w-4 text-white hover:text-indigo-500" />
                  </button>
                </Badge>
              );
            })}
        ...
        <div className="relative">
          {open && (
            <CommandList
              className="absolute top-1 z-10 w-full rounded-md border bg-white text-gray-600 text-popover-foreground shadow-md outline-none animate-in"
              onMouseLeave={() => {
